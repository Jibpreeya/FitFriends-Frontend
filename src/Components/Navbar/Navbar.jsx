    ...
    <div className={showNavbar ? "Nav-content" : "Nav-content hide"}>
      ...
      <div >
        {showLogin ? (
          ...
          <div className="Show__login__complete login-name">
            <div></div>
            <button onClick={props.handleClick} style={{ color: "white" }}>Log out </button>
          </div>
        )}
      </div>
      {/* Mobile */}
